...
class CourseUnifiedScreen extends StatefulWidget {
  const CourseUnifiedScreen({super.key});

  @override
  State<CourseUnifiedScreen> createState() => _CourseUnifiedScreenState();
}

class _CourseUnifiedScreenState extends State<CourseUnifiedScreen> {
